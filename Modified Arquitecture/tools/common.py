...
def cte2num(cte):
    try:
        ...
        print("Error: Can not convert \"" + cte + "\"")
        return None
    if 0 <= val and val <= 31:
        return val
    print("Error: \"" + cte + "\" out of range (0-31)")
    raise ValueError()
        ...
        try:
            ...
            # STR || LOAD
                ...
                if i[0] == "STR" and i[1] == "[" and i[3] == "]" and i[
                    ...
                    appendParse(parseBytes, parseHuman, i, n)
                elif i[0] == "STR" and i[1] == "[" and i[3] == "+" and i[5] == "]" and i[6] == ",":
                    # STR [Rx+cte5],RY  || [Rx+cte5] <= Ry
                    if i[2][0] != "R":
                        raise ValueError("Error: Invalid registrer \"" + i[2] + "\"")
                ...
                elif i[0] == "LOAD" and i[2] == "," and i[3] == "[" and i[5] == "+" and i[7] == "]":
                    # LOAD Rx, [RY+cte5]  || Rx <= [Ry+cte5]
                    if i[4][0] != "R":
                        raise ValueError("Error: Invalid registrer \"" + i[2] + "\"")
